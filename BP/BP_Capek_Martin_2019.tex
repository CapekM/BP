...
\chapter{Analýza}
    ...
    \section{Výběr nástroje pro návrh a dokumentaci API}
        ...
        \subsection{OpenAPI Specifikace vs API Blueprint}
            ...
            OAS je založený na YAML (nebo JSON) formátu a API Blueprint na syntaxi podobné Markdownu a MSON\footnote{https://github.com/apiaryio/mson}
...
\chapter{Vývojářské prostředí pro OS~Linux}
    ...
    \section{Použité technologie}
        ...
        \subsection{JWT}
            JWT (JSON Web Token) je standart, který zajišťuje bezpečný přesun informací zapsaných v JSON. V naší aplikaci využijeme tuto technologii pro ověřování totožnosti uživatelů.
            \begin{figure}[ht!]
