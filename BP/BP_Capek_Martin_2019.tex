...
V další části provedu návrh API s použitím nástroje Swagger, který byl vybrán v analýze, a s ohledem na současný stav databáze projektu Věnná města českých královen.
Nakonec je popsán vývoj API a implementace funkčního prototypu. Tento prototyp je podroben testování.}
...
In the next part, I will design the API using Swagger tool from the analysis and with regard to the current state of the database of the project Dowry Towns of the Queens of Bohemia.
Finally, API development and functional prototype implementation are described. This prototype is being tested.}
