...
import { createBasicUsers } from "./controller/user";
    ...
    \section{Implementace} \label{impl}
        Zde popíši jak vypadá prototyp Rest API pro Editor virtuální reality. Naše implementace navazuje na předchozí sekci \hyperref[vyvProstredi]{Vývojářské prostředí pro OS Linux}. Jelikož se na databázi v projektu Věnná města českých královen ještě pracuje, bylo rozhodnuto, že v prototypu budou pouze entity User a Model a koncové body k těmto entitám.
